      ...
      <div className="flex flex-col lg:flex-row justify-between">
        ...
        <div>
          ...
          <div className="flex justify-between max-w-[390px] w-full">
            <button onClick={() => filterPrice('5$')} className="m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white">
              5$
            </button>
            ...
            <button onClick={() => filterPrice('35$')} className="m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white">
              35$
            </button>
          </div>
        </div>
